...
df_train = df.iloc[:(-50), :].copy()# -50 refers to counting 50 from the last record. Thus from first record to (end-50)
...
epochs = 100000
batch_size = 5#100# if not specified, it will use batch size specified in the method!!
KEEP_RATE = 0.7 #0.7
train_losses = []
val_losses = []
